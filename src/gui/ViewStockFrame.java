...
public class ViewStockFrame extends javax.swing.JFrame {
    ...
    public ViewStockFrame(Stock supplier) {
        this.stock = supplier;
        initComponents();
        initData();
    }
    ...
    public void initData() {
        jTextField1.setText(stock.getStockBarcode() + "");
        jTextField2.setText(stock.getGrn().getPurchaseOrder().getProduct().getProductName());
        jTextField3.setText(stock.getExpDate() + "");
        jTextField4.setText(stock.getMnfDate() + "");
        jTextField6.setText(stock.getUnitPrice() + "");
        jTextField7.setText(stock.getDiscount() + "");
        jTextField8.setText(stock.getAvailableQty()+"");
    ...
    private void initComponents() {
        ...
        jLabel10.setText("ExpriedDate");

        jTextField3.setEnabled(false);

        jLabel11.setText("Mnf Date");
        ...
        jLabel3.setText("Default Discount");
